...
const workspaces = [
  { id: "1", name: "ChatGenius", logo: "", members: 12, isAdmin: true },
  { id: "2", name: "Design Team", logo: "", members: 8, isAdmin: false },
  { id: "3", name: "Marketing", logo: "", members: 5, isAdmin: false },
];
...
export default function WorkspaceSwitcher({ 
  ...
  const handleWorkspaceSelect = (workspaceId: string) => {
    // Just update the active workspace, don't navigate
    // This would typically update some workspace context or state
